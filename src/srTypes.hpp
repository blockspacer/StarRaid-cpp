enum netMessageType {
	CLIENT_CONNECTED,  	  //!< After client connected
...
static const char * netMessageTypenames[] = {
	"CLIENT_CONNECTED",
	"PING",
	"PONG",
	"VERSION_ASK",
...
// generated from MessageIdentifiers.h via sublime multiline edit
static const char * rakNetMessageNames[] = {
	"ID_CONNECTED_PING",
	"ID_UNCONNECTED_PING",
